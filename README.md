...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/testcloudflare)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/testcloudflare
```

A live public deployment of this template is available at [https://testcloudflare.templates.workers.dev](https://testcloudflare.templates.workers.dev)
